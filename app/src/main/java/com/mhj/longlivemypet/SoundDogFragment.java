...
public class SoundDogFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup)inflater.inflate(R.layout.fragment_sound_dog, container, false);
        ...
        rootView.findViewById(R.id.button_dog).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        rootView.findViewById(R.id.button_tiger).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (soundLoad == true) {
        ...
        rootView.findViewById(R.id.button_pig).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (soundLoad == true) {
        ...
        rootView.findViewById(R.id.button_monkey).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (soundLoad == true) {
        ...
        rootView.findViewById(R.id.button_horse).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (soundLoad == true) {
        ...
        rootView.findViewById(R.id.button_frog).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (soundLoad == true) {
